...
namespace ConsoleApp1
{
	class Program
	{
		...
		private static void InitializeTestDT()
		{
			...
			TestDT.Add(new DateTime(2019, 4, 30, 6, 12, 53));
			TestDT.Add(new DateTime(2019, 4, 11, 6, 12, 53));
			TestDT.Add(new DateTime(2019, 4, 7, 6, 12, 53));
			TestDT.Add(new DateTime(2019, 3, 29, 9, 31, 14));
			TestDT.Add(new DateTime(2019, 3, 28, 9, 31, 14));
			TestDT.Add(new DateTime(2019, 3, 27, 9, 31, 14));
			TestDT.Add(new DateTime(2018, 10, 19, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 9, 30, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 8, 24, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 8, 23, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 7, 12, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 6, 29, 0, 0, 0));
			TestDT.Add(new DateTime(2018, 5, 13, 0, 0, 0));
			TestDT.Add(new DateTime(2017, 5, 28, 0, 0, 0));
		}
